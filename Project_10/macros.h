...
#define THIRTY_FIVE_COUNTS (35)
#define TWENTY_COUNTS (20)
#define FIVE_COUNTS (5)

#define THREE_COUNTS (3)
#define EXIT_TURN_TIME (6)
#define EXIT_FORWARD_TIME (20)
