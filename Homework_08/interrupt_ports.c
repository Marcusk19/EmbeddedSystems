...
__interrupt void switchP4_interrupt(void){
  ...
  if(P4IFG & SW1){
    ...
    UCA1_index = BEGINNING;              // enable transmit interrupt
    UCA1TXBUF = test_command[RESET_STATE];
    UCA1IE |= UCTXIE; 
...
__interrupt void switchP2_interrupt(void){
  ...
  if(P2IFG & SW2){
    ...
    UCA1_index = RESET_STATE;              // enable transmit interrupt
    UCA1TXBUF = test_command[RESET_STATE];
    UCA1IE |= UCTXIE; 
